...
import project.euna.manager.dao.PersonalManagerDAO;


@Service
@Transactional(propagation = Propagation.REQUIRED)
public class PersonalManagerServiceImpl implements PersonalManagerService {
	@Autowired
	private PersonalManagerDAO managerDAO;
